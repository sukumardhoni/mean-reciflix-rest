...
module.exports = function (app) {
   ...
   'https://www.googleapis.com/auth/userinfo.email'
	...
	app.route('/users/updateProfile').put(users.ensureAuthenticated, users.update);
	app.route('/users/changePassword').post(users.ensureAuthenticated, users.changePassword);
