...
]).run(["$rootScope", "$state", "$localStorage", "$http", "$location", function ($rootScope, $state, $localStorage, $http, $location) {
...
angular.module('categories').controller('RecipesUpdateCtrl', ["$scope", "$state", "$localStorage", "Recipe", "$rootScope", "Categories", "SubCategories", "SubCategoryRecipes", "CategoryRecipes", "$sce", "RecipesService", "NotificationFactory", function ($scope, $state, $localStorage, Recipe, $rootScope, Categories, SubCategories, SubCategoryRecipes, CategoryRecipes, $sce, RecipesService,NotificationFactory) {
